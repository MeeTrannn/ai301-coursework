...
I am most familiar with Python, I am most familiar with editing a simple python file but not understand how all the files work together in a real backend system. I want to get better at Data Engineering so I want to work more with database, datawarehouses, SQL,... in a real production system. Avoid boring skills needed by a pure Software Engineer but not a Data Engineer one. 
